...
function renderChoose(index){
	...
	//	str +='<span><img src="img/album'+dataBase[i].id+'.jpg" /><div class="l-year">'+dataBase[i].time+'</div><div class="l-singer">'+dataBase[i].singer+'</div><div class="l-singername">'+dataBase[i].name+'</div></span>'
